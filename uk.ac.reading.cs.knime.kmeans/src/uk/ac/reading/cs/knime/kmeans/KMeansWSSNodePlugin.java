 ...
 */
public class KMeansWSSNodePlugin extends Plugin {
    // The shared instance.
    private static KMeansWSSNodePlugin plugin;

    /**
     * The constructor.
     */
    public KMeansWSSNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static KMeansWSSNodePlugin getDefault() {
        return plugin;
    }
